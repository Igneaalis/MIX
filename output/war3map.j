...
constant integer si__RegisterNativeEvent__NativeEvent=53
...
constant integer si__ResourcePreloader__S=57
...
call ExecuteFunc("jasshelper__initstructs662258843")
...
function jasshelper__initstructs662258843 takes nothing returns nothing
